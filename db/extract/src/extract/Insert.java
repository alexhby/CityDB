...
public class Insert {
	...
	static String URL = "mongodb://citydb:citydb1234@ds129469.mlab.com:29469/citydb";
	
	static int port = 11734;
...
//		DBAddress address = new DBAddress(URL);

//		db = MongoClient.connect(address);
...
//		document.put("createdDate", new Date());
		...
		List<String> curr_values = new ArrayList<String>();
		
		curr_values.addAll(values);
		...
		if(values.size() > 1)
		{
			...
			document.put(key, curr_values);

		}
		else
		{
			document.put(key, curr_values.get(0));
		}
