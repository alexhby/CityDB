		...
		<div id="content">
			...
			<div id="msg">
				<div id="msgbox">
					<div id="message">
					<p class="m">
					<span class="nick">123</span>&nbsp;&nbsp;
					<span class="time"><% java.util.Date now=new java.util.Date(); out.println(now);%> </span><br>
					<span class="msg" style="color:#ffffff">&nbsp;&nbsp;&nbsp;&nbsp;欢迎来到
					 <script type="text/javascript">
					 	document.write("${location}，您想了解它哪方面的内容？");
